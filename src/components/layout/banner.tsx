...
export default function Banner() {
  ...
  return (
    <div className="wrapper max-w-[1200px] pl-0 md:pl-24">
      <h1 className="text-custom-red text-xl md:text-6xl lg:text-8xl font-semibold md:font-bold relative md:absolute left-20 rotate-0 md:-rotate-90 top-[44%] translate-x-0 md:-translate-x-1/2 z-40">
        Top Anime
      </h1>
      <Swiper
        ...
        {data &&
          ...
          data.map((animeItem: AnimeProps) => {
            ...
            return (
              ...
              >
                <div className="block md:flex justify-center gap-8 mx-auto  p-4 rounded">
                  <img
                  ...
                  <ScrollArea className="h-[565px] w-full pr-2">
                    <div className="w-full text-left space-y-2">
                      ...
                      {animeItem?.genres && (
                        <p>
                          <span className="font-bold leading-relaxed text-neutral-400">
                            {animeItem?.genres.length > 1 ? "Genres" : "Genre"}:{" "}
                          </span>
                          {animeItem?.genres
