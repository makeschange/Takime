...
export const getPopularAnime = async (): Promise<AnimeProps> => {
  const response = await axios.get("/v4/top/anime?filter=bypopularity");
  return response.data.data;
};

export const getCurrentAiredAnime = async (): Promise<AnimeProps> => {
  const response = await axios.get("/v4/top/anime?filter=airing");
  return response.data.data;
};

export const getUpcomingAnime = async (): Promise<AnimeProps> => {
  const response = await axios.get("/v4/top/anime?filter=upcoming");
  return response.data.data;
};

export const getAnime = async (id: string): Promise<AnimeProps> => {
  const response = await axios.get(`/v4/anime/${id}/full`);
  return response.data.data;
};
...
export const getAnimeCharacters = async (
  ...
  const response = await axios.get(`/v4/anime/${id}/characters`);
  return response.data.data;
};
...
export const getAnimeCharacterPictures = async (
  ...
  const response = await axios.get(`/v4/characters/${id}/pictures`);
  return response.data.data;
};
...
export const getAnimeRecommendations = async (
  ...
  const response = await axios.get(`/v4/anime/${id}/recommendations`);
  return response.data.data;
};

export const getSearchAnime = async (query: string): Promise<AnimeProps> => {
  const response = await axios.get(`/v4/anime?q=${query}`);
  return response.data.data;
};
